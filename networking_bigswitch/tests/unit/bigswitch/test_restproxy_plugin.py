...
from networking_bigswitch.tests.unit.bigswitch import test_base as bsn_test_base

patch = mock.patch
HTTPCON = 'networking_bigswitch.plugins.bigswitch.servermanager.httplib.HTTPConnection'
...
class TestBigSwitchProxyPortsV2(test_plugin.TestPortsV2,
    ...
    def test_correct_shared_net_tenant_id(self):
        ...
        with self.network(tenant_id='SHARED', shared=True) as net:
            with self.subnet(network=net) as sub:
                pref = 'networking_bigswitch.plugins.bigswitch.servermanager.ServerPool.%s'  # noqa
