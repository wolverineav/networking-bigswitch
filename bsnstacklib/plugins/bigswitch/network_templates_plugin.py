...
class NetworkTemplatesPlugin(service_base.ServicePluginBase,
                             networktemplates.NetworkTemplatesPluginBase,
    ...
    def get_plugin_name(self):
        return 'network_template_plugin'

    def get_plugin_description(self):
        return "Network Template - heat network templates"
